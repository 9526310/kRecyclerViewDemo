package com.zm.recyclerviewtest.adapter;
...
import com.zm.recyclerviewtest.R;
...
public class MyRecyclerviewAdapter extends RecyclerView.Adapter<MyRecyclerviewAdapter.MyViewHolder> implements View.OnClickListener,View.OnLongClickListener {
    ...
    public MyRecyclerviewAdapter(Context context, ArrayList<Student> arrayList,int itemLayoutId) {
